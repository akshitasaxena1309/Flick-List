...
exports.addListPage = async (req, res) => {
  ...
  for (const cartItem of movies.cart) {
    const movie = await Movies.findById(cartItem.movie);
    cartWithMovies.push(movie);
  }
